            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-countryUsers">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.user.fields.is_profile_completed') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                {{ App\Models\User::IS_PROFILE_COMPLETED_RADIO[$user->is_profile_completed] ?? '' }}
                            </td>
                            <td>
                                @can('user_show')
...
@endcan
  ...
  let table = $('.datatable-countryUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })

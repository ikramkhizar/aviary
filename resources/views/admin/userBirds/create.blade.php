...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.userBird.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-birds.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="mutation_name">{{ trans('cruds.userBird.fields.mutation_name') }}</label>
                <input class="form-control {{ $errors->has('mutation_name') ? 'is-invalid' : '' }}" type="text" name="mutation_name" id="mutation_name" value="{{ old('mutation_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ring_no') ? 'is-invalid' : '' }}" type="text" name="ring_no" id="ring_no" value="{{ old('ring_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('male_parent') ? 'is-invalid' : '' }}" type="text" name="male_parent" id="male_parent" value="{{ old('male_parent', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('female_parent') ? 'is-invalid' : '' }}" type="text" name="female_parent" id="female_parent" value="{{ old('female_parent', '') }}">

...
<div class="form-group">
    <a class="btn btn-primary" href="{{ route('admin.breeding-histories.index', $breedingPair->id) }}">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.breeding-histories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clutch_no') ? 'is-invalid' : '' }}" type="number" name="clutch_no" id="clutch_no" value="{{ old('clutch_no', '') }}" step="1" min="1" oninput="validity.valid||(value='');">
            ...
            <div class="hatch_date_area">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mutation_name') ? 'is-invalid' : '' }}" type="text" name="mutation_name" id="mutation_name" value="{{ old('mutation_name', '') }}">
            ...
            <input type="hidden" name="pair_id" value="{{ $breedingPair->id }}">
            <div class="form-group">

...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Specie">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($species as $key => $specie)
                        <tr data-entry-id="{{ $specie->id }}">
                            ...
                            <td>
                                @can('specie_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.species.show', $specie->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
...
@endcan
  ...
  let table = $('.datatable-Specie:not(.ajaxTable)').DataTable({ buttons: dtButtons })
